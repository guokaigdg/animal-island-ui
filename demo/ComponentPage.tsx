...
export const PAGE_INFO: Record<string, { title: string; desc: string }> = {
    ...
    loading: {
        title: 'Loading 加载',
        desc: '治愈海岛风格小岛 Loading 动画组件，支持自定义样式和类名',
    },
    table: {
        title: 'Table 表格',
    ...
    'wedding-invitation': {
        ...
        desc: '治愈海岛风格婚礼请柬组件 — 内置叶子边角、飘散花瓣、心跳爱心、吉祥物头像，所有装饰均为内联 SVG，无需外部素材',
    },
    wallet: {
        title: 'Wallet 钱包',
        desc: '治愈海岛风格金币展示 — 奶油描边的橄榄黄胶囊 + 上凸钱袋图标，支持千分位格式化、自定义图标与三种尺寸',
    },
    form: {
        title: 'Form 表单',
