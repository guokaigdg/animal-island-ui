...
31 components plus 3 companion exports (`FormItem` / `useForm` / `ICON_LIST`), all exported from `src/index.ts`:
...
| `Icon`         | lucide icon set (13 built-in names + any lucide-react icon via `icon`)                                                                                                                                                                             |             | ✓                         |
